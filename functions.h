...
{                                           //
    ...
    void runTimer();                        // Step 6a: Execute main timer functions from main() while loop
    bool pauseTimer();                      // Step 6b: Listen for keypress to pause active timer
    void resetTimer();                      // Step 7a: Handle timer reset or program exit after expiration
    void restartTimer();                    // Step 7b: Handle timer restart or program quit after pause
...
{                                   //
    ...
    void timerCore();               // Core program logic; increments timers and sets/syncs visual elements
    void timerCoreConfig();
}
