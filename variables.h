...
inline bool noteIsSet;      //Hooks the main program loop to call getNote() if note option as not been selected
...
inline const string TEXT_BG_SLATE = "\033[48;5;238m";   //Console output escape code for gray colored background
